          ...
          <div className="flex flex-wrap gap-4">
            {(userRole === 1) && (
              <>
                ...
                <Link to="/generate-ipfs-json" className="bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors inline-flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
